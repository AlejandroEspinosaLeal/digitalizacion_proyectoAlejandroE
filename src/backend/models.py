...
class User(SQLModel, table=True):
    """Core PostgreSQL User entity storing encrypted passwords and Brute-Force lockout configurations."""
...
class Device(SQLModel, table=True):
    ...
    id: str = Field(primary_key=True)  # Hard-Coded Agent UUID
    name: str
...
class SortingRule(SQLModel, table=True):
    """Relational table storing dynamic Cloud-Synched file extensions mapped to Categories."""
    id: Optional[int] = Field(default=None, primary_key=True)
